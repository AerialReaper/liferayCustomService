...
package iconsApi2.service.persistence.impl;
...
import iconsApi2.model.impl.FooImpl;
import iconsApi2.model.impl.FooModelImpl;

import iconsApi2.service.persistence.FooPersistence;
import iconsApi2.service.persistence.impl.constants.CivicaPersistenceConstants;
...
public class FooPersistenceImpl
	...
	@Override
	@Reference(
		target = CivicaPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.iconsApi2.model.Foo"),
			true);
	}

	@Override
	@Reference(
		target = CivicaPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
