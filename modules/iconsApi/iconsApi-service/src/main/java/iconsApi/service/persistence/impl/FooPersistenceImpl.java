...
package iconsApi.service.persistence.impl;
...
import iconsApi.exception.NoSuchFooException;

import iconsApi.model.Foo;
import iconsApi.model.impl.FooImpl;
import iconsApi.model.impl.FooModelImpl;

import iconsApi.service.persistence.FooPersistence;
import iconsApi.service.persistence.impl.constants.FOOPersistenceConstants;
...
public class FooPersistenceImpl
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.iconsApi.model.Foo"),
			true);
	}
